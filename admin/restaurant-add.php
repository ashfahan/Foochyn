              ...
              <div class="relative">
                ...
                <fieldset class="STEP bg-white is-round shadow p-4 w-24">
                  ...
                  <div class="my-1rem">
                    <h5>Add Table</h5>
                    <div class="flex">
                      <input class="input is-box" placeholder="Table Name" />
                      ...
                      <input type="number" class="input is-box" placeholder="Capacity" />
                      <input class="input is-box" placeholder="Action" />
                      <button class="btn is-sld is-primary">Add</button>
                    </div>
                  </div>
