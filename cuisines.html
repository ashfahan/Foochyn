...
<html lang="en">
    ...
    <body>
        ...
        <main class="container  my-4">
            ...
            <section class="bg-white p-2 my-4 is-round-sm">
                <h6 class="mb-1rem">Popular Locations for Restaurants in Mumbai</h6>
                <hr size="4">
                <div class="grid has-gap-lg is-adjust">
                    <div class="column w-6">
                        <div class="is-lg">Viviana Mall, Majiwada</div>
                        <div class="clr-disabled">78 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Andheri Lokhandwala, Western Suburbs</div>
                        <div class="clr-disabled">159 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Bandra Kurla Complex (BKC), Western Suburbs</div>
                        <div class="clr-disabled">112 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Andheri West, Western Suburbs</div>
                        <div class="clr-disabled">302 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Bandra West, Western Suburbs</div>
                        <div class="clr-disabled">46 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Powai, Central Mumbai</div>
                        <div class="clr-disabled">199 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Colaba, South Mumbai</div>
                        <div class="clr-disabled">148 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Lower Parel, South Mumbai</div>
                        <div class="clr-disabled">279 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Worli, South Mumbai</div>
                        <div class="clr-disabled">97 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Fort, South Mumbai</div>
                        <div class="clr-disabled">220 restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Thane Region</div>
                        <div class="clr-disabled">2 restaurants</div>
                    </div>
                    <div class="column w-6">
                        Restaurants Near Me, Mumbai
                    </div>
                </div>
            </section>

            <section class="bg-white p-2 my-4 is-round-sm">
                <h6 class="mb-1rem">Top Restaurants in Mumbai</h6>
                <hr size="4">
                <div class="grid has-gap-lg is-adjust">
                    <div class="column w-6">
                        <div class="is-lg">Seven Kitchens</div>
                        <div class="clr-disabled">The St. Regis, Mumbai</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Mirchi And Mime</div>
                        <div class="clr-disabled">Powai, Central Mumbai</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">The Bombay Canteen</div>
                        <div class="clr-disabled">Lower Parel, South Mumbai</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Farzi Cafe</div>
                        <div class="clr-disabled">Lower Parel, South Mumbai</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">The Wine Rack</div>
                        <div class="clr-disabled">High Street Pheonix, Lower Parel</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Barbeque Nation</div>
                        <div class="clr-disabled">Atria Mall, Worli</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Yauatcha</div>
                        <div class="clr-disabled">Bandra Kurla Complex (BKC), Western Suburbs</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Hemant Oberoi</div>
                        <div class="clr-disabled">Bandra Kurla Complex (BKC), Western Suburbs</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">London Taxi</div>
                        <div class="clr-disabled">Lower Parel, South Mumbai</div>
                    </div>
                    <div class="column w-6">
                        Restaurants Near Me, Mumbai
            ...
            <section class="bg-white p-2 my-4 is-round-sm">
                <h6 class="mb-1rem">Top Collections in Mumbai</h6>
                <hr size="4">
                <div class="grid has-gap-lg is-adjust">
                    <div class="column w-6">
                        <div class="is-lg">Best Biryani Restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">DJ Restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Pure Veg Restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Romantic Restaurants</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Happy Hours</div>
                    </div>
                    <div class="column w-6">
                        <div class="is-lg">Sunday Brunches</div>
                    </div>
                </div>
            </section>

            <section class="bg-white my-4 is-round-sm grid">
                <div class="column w-12 img-bg" style="background-image: url('./images/download_app.jpg');"></div>
                <div class="column w-12 p-2">
                    <h3>Your favourite app for eating out</h3>
                    <div class="mb-6 is-lg">Instant restaurant reservation with guaranteed deals in more than 8000+ restaurants across India & Dubai</div>
                    <div class="mb-6 is-lg font-bold">Download the EazyDiner App from the links below and get ₹100 in your EazyWallet</div>
                    <div>
                        <img class="w-8" src="./images/google.webp" alt="">
                        <img class="w-8" src="./images/apple.png" alt="">
                    </div>
                </div>
            </section>
