<aside class="menu is-primary clr-white bg-dark shadow h-100 h-min-100vh">
  <div href="#" class="txt-center py-1rem h2 mb-0">User Dashboard</div>
  ...
  <a href="#" class="menu-item py-1rem">
    <i class="icon is-lg ri-building-2-line"></i>&nbsp;<span>Notification</span>
  </a>
  <a href="#" class="menu-item py-1rem">
    <i class="icon is-lg ri-building-2-line"></i>&nbsp;<span>Booking history</span>
  </a>
</aside>